...
export const Hero = (): h.JSX.Element => {
  return (
    <section
      ...
      <h1
        class={tw`z-10 mx-auto max-w-screen-sm bg-gradient-to-tl from-blue-700 to-blue-400 bg-clip-text text-4xl leading-snug tracking-wide dark:from-blue-500 dark:to-blue-200 md:text-center md:text-6xl`}>
        Hi, I'm
